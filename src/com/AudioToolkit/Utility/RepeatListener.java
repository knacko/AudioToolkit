...
public class RepeatListener implements OnTouchListener {
    ...
    private Runnable handlerRunnable = new Runnable() {
        ...
        public void run() {
        	...
        	if (intervalIncrement > 0) {
        		...
        		if (interval < intervalBound) interval += intervalIncrement; 
        		        		
        	} else if (intervalIncrement < 0) {
        		if (interval > intervalBound) interval += intervalIncrement;
        	}
     ...
     *       periodically
     */
    public RepeatListener(int initialInterval, int normalInterval, int intervalIncrement, int intervalBound, 
        ...
        this.intervalBound = intervalBound;
